...
UNITS = (
    ("alpha-1", "SFGPUCI----K---", "ALPHA 1", 6.13, 49.61, 0.045, 0.025, 0.0),
    ("red-2", "SHGPUCA----K---", "RED 2", 6.32, 49.68, 0.055, 0.018, 2.1),
    ("echo-3", "SNGPUCR----K---", "ECHO 3", 5.98, 49.52, 0.035, 0.030, 4.2),
)
